---
name: cloudflare-worker-expert
description: Expert for Cloudflare Workere platform. Use proactively for Cloudflare workers platform tasks and queries. Cloudflare Images, Video, Image resizing all belong there.
